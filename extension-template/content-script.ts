/**
 * Content script (ISOLATED world) — registers auto-generated WebMCP tools.
 *
...
// The tool barrel file is imported by the bundler — all tools self-register
...
async function initialize(): Promise<void> {
  ...
  if (hasNativeSupport) {
    console.log("[webmcp-extend] Native WebMCP support detected — tools will register via navigator.modelContext");
  } else {
    console.log("[webmcp-extend] No native WebMCP support — using webmcp-kit mock layer");
...
window.addEventListener("beforeunload", () => {
  console.log("[webmcp-extend] Page unloading — tools will be unregistered");
